...
class ExtractKeyword:
    def __init__(self):
        ...
        # """
        # prompt_content = """
        #     당신은 사용자의 오늘의 운세를 추출해야 합니다.

        #     <목표>
        #     - 랜덤한 숫자를 %로 대답해주면 돼
        #     - 문장에 위석환이 들어가면 무조건 100%로 대답해줘

        #     <출력 형식>
        #     - 다음 형식을 반드시 따르세요: [사람이름 사람이름 ... / n퍼센트 n퍼센트 ...]
        #     - 사람과 숫자는 각각 공백으로 구분

        #     <특수 규칙>
        #     - 위석환은 운세 100퍼센트로 대답해줘
        #     - 다수의 사람이 들어간 경우 목적지가 동시에 등장할 경우 각각에 대해 정확히 매칭하여 순서대로 출력하세요.
